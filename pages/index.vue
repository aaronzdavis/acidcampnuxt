  ...
  <div class="main-content">
    <div class="header">
      ...
      <ul>
        ...
        <li>
          <a target="_blank" href="https://www.instagram.com/acidcamp"
            >Instagram</a
          >
        </li>
        <li>
          <a target="_blank" href="https://soundcloud.com/acidcamp"
            >Soundcloud</a
          >
        </li>
      </ul>
    ...
    <div class="flex-container">
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr009.jpg"
          /></a>
        </div>
        <div class="name">
          ACR009<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr008.jpg"
          /></a>
        </div>
        <div class="name">
          ACR008<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr007.jpg"
          /></a>
        </div>
        <div class="name">
          ACR007<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a href="https://acidcamp.bandcamp.com/album/mdf" target="_blank"
            ><img loading="lazy" src="~/assets/images/acr006.jpg"
          /></a>
        </div>
        <div class="name">
          ACR006<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr005-15.jpg"
          /></a>
        </div>
        <div class="name">
          ACR005 1.5<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr005-10.jpg"
          /></a>
        </div>
        <div class="name">
          ACR005 1.0<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr004.jpg"
          /></a>
        </div>
        <div class="name">
          ACR004<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr-iii.jpg"
          /></a>
        </div>
        <div class="name">
          ACR003<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a
            ...
            target="_blank"
            ><img loading="lazy" src="~/assets/images/acr-ii.jpg"
          /></a>
        </div>
        <div class="name">
          ACR002<br />
      ...
      <div class="flex-item">
        <div class="cover">
          <a href="https://acidcamp.bandcamp.com/album/corot-7b" target="_blank"
            ><img loading="lazy" src="~/assets/images/acr-i.jpg"
          /></a>
        </div>
        <div class="name">
          ACR001<br />
    ...
    <div class="acid-smile" @click="triggerMusic">
      <img src="~/assets/images/acid-smile.svg" />
    </div>
    <div class="acid-dancer">
      <img src="~/assets/images/dancetestblack.gif" />
    </div>
  </div>
</template>
